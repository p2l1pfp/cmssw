#include "L1Trigger/Phase2L1Jets/interface/L1SeedConePFJetProducer.h"
...
void L1SeedConePFJetProducer::produce(edm::StreamID /*unused*/, edm::Event& iEvent, const edm::EventSetup& iSetup) const 
{
