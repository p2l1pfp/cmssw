...
scPFL1PuppiEmulatorCorrected = L1SeedConePFJetEmulatorProducer.clone(L1PFObject = cms.InputTag('l1ctLayer2Deregionizer', 'Puppi'),
...
l1PFJetsTask = cms.Task(
    ...
    l1ctLayer2Deregionizer, scPFL1PF, scPFL1Puppi, scPFL1PuppiEmulator, scPFL1PuppiEmulatorCorrected
)
