...
pfClustersFromCombinedCalo = cms.EDProducer("L1TPFCaloProducer",
     ecalCandidates = cms.VInputTag(cms.InputTag('pfClustersFromL1EGClusters:all')), # using EM from towers in HGC, no longer reading also 'pfClustersFromHGC3DClustersEM'  
