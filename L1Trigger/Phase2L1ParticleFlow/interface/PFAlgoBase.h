...
namespace l1tpf_impl { 
  ...
  class PFAlgoBase {
    public:
        ...
        virtual void assignTracksToPV(std::vector<Region> &rs, const float &vz, const l1t::Vertex vtx) const ; // region is not const since it sets the fromPV bit of the tracks
